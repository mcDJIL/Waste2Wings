...
const navItems = [
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path d="M10 6V0H18V6H10ZM0 10V0H8V10H0ZM10 18V8H18V18H10ZM0 18V12H8V18H0ZM2 8H6V2H2V8ZM12 16H16V10H12V16ZM12 4H16V2H12V4ZM2 16H6V2H12V4ZM2 16H6V14H2V16Z" fill="currentColor" />
      </svg>
    ),
  },
  {
  ...
  {
    label: 'Audit Trail',
    path: '/stakeholder/audit-logs',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
        <path d="M19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3ZM19 19H5V5H19V19ZM7 10H17V12H7V10ZM7 7H17V9H7V7ZM7 13H14V15H7V13Z" fill="currentColor" />
      </svg>
    ),
  },
]
