  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] flex">
      ...
      <div className="flex-1 flex flex-col lg:ml-[279px] min-w-0">
        ...
        <main className="flex-1 flex flex-col gap-4 sm:gap-6 p-4 sm:p-6 lg:p-[26px_48px_48px]">
      ...
      {showDetailModal && selectedSubmission && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-2 xs:p-4">
          <div className="bg-white rounded-2xl max-w-md w-full min-w-0 max-h-[80vh] overflow-y-auto">
            <div className="sticky top-0 bg-white flex items-start justify-between gap-3 px-4 sm:px-6 py-3 sm:py-4 border-b border-[#BEC9C3]/20">
              <h2 className="min-w-0 break-words text-[#004536] font-bold text-base sm:text-lg">Detail Setoran</h2>
              <button
