  ...
  return (
    <div className="flex min-w-0 flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
      <div className="min-w-0 flex flex-col gap-1">
        <h2 className="text-[#004536] text-lg font-extrabold leading-6 sm:text-xl">Prediksi Dana</h2>
        <p className="break-words text-sm font-semibold leading-5 text-[#3F4945] sm:text-base sm:leading-6">
      ...
      <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:flex-shrink-0">
        <button className="flex w-full items-center justify-center gap-2 rounded-lg border-2 border-[#C9A96E] px-4 py-2 text-sm font-extrabold leading-5 text-[#C9A96E] transition-colors duration-200 hover:bg-[#C9A96E]/10 sm:w-auto sm:gap-3 sm:px-6 sm:text-base sm:leading-6">
        ...
        <button className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#004536] px-4 py-2.5 text-sm font-extrabold leading-5 text-white transition-colors duration-200 hover:bg-[#0B5E4B] sm:w-auto sm:gap-2.5 sm:px-6 sm:text-base sm:leading-6">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
