  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        <button className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-[#BEC9C3]/40 bg-white text-[#3F4945] text-sm font-medium transition-all duration-200 hover:border-[#004536] hover:text-[#004536] hover:shadow-sm active:scale-95 whitespace-nowrap">
